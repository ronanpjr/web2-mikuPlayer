                                    ...
                                    {vocaloid.songs.map((songTitle) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className="w-full text-left px-4 py-3 rounded-xl bg-white/5 hover:text-white transition-all group flex items-center justify-between"
                                                style={{
                                                    '--hover-bg': `${vocaloid.color}33`
                                                }}
                                                onMouseEnter={(e) => e.currentTarget.style.backgroundColor = `${vocaloid.color}33`}
                                            ...
                                            >
                                                ...
                                                <svg
                                                    ...
                                                    viewBox="0 0 24 24"
                                                    fill="currentColor"
                                                    className="opacity-0 group-hover:opacity-100 transition-opacity shrink-0 ml-3"
                                                    style={{ color: vocaloid.color }}
                                                >
