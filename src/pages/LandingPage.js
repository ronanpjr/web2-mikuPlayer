                ...
                <header>
                    <div className="logo-container">
                        <img
                            ...
                            className="logo-icon"
                        />
                        <h2 className="logo-text">MIKU MIKU MUSIC</h2>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                        <Link to="/vocaloids" style={{
                            padding: '0.5rem 1rem',
                            background: 'rgba(0, 221, 192, 0.1)',
                            borderRadius: '0.5rem',
                            color: 'inherit',
                            textDecoration: 'none',
                            fontSize: '0.875rem',
                        ...
                        <button id="theme-toggle-button" onClick={toggleTheme}>
                            ...
                            <svg className="moon-icon" style={{ display: isLightMode ? 'block' : 'none' }} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
                        </button>
                    </div>
                </header>
